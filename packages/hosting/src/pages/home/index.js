...
export const HomeIntegration = () => {
  return (
    <Container>
      ...
      <Title level={4}>Nuestras funciones y ventajas:</Title>
      <div className="cards-wrapper">
        ...
        <CardStyled>
          ...
          <div className="texts">
            ...
            <Text>
              Cada trámite cuenta con un QR único, para evitar documentos falsos
            </Text>
          </div>
        </CardStyled>
        <CardStyled>
          <div className="icon">
            <FontAwesomeIcon icon={faClockRotateLeft} size="6x" />
          </div>
          <div className="texts">
