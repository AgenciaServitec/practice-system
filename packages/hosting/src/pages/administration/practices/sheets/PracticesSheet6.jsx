            ...
            <tr>
              <td>
                <div className="item-row">
                  <span>4. </span>
                  <span>
                    Plantea soluciones acertadas a problemas que se originan en
                    el trabajo.
                  </span>
                </div>
              </td>
            ...
            <tr>
              <td>
                <div className="item-row">
                  <span>7. </span>
                  <span>
                    Coopera con la conservación, matenimiento de los equipos de
                    la empresa.
                  </span>
                </div>
              </td>
              ...
              <td>
                <div className="item-row">
                  ...
                  <span>
                    ...
                    materiales, máquinas de oficina, taller, laboratorio o
                    campo.
                  </span>
                </div>
              </td>
            ...
            <tr>
              <td>
                <div className="item-row">
                  <span>18. </span>
                  <span>
                    Participa activamente en los clubes deportivos y/o
                    culturales de su empresa.
                  </span>
                </div>
              </td>
              <td>1</td>
            ...
            <tr>
              <td>
                <div className="item-row">
                  <span>20. </span>
                  <span>
                    Ejecuta acciones de adiestramiento espontáneo a sus
                    compañeros de trabajo cuando lo requiera el caso.
                  </span>
                </div>
              </td>
              <td>1</td>
